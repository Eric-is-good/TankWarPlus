...
def main():
    ...
    gameover = pygame.image.load(r"..\image\gameover.png")
                    ...
                    if each.bullet.life:
                        ...
                        if each.bullet.strong:
                            ...
                            if pygame.sprite.spritecollide(each.bullet, bgMap.ironGroup, False, None):
                                each.bullet.life = False
                        # 子弹 碰撞 基地
                        if pygame.sprite.spritecollide(each.bullet, jidi.jidi, True, None):
                            homeSurvive = False
